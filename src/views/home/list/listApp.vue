<template>
  <div id="app">
    ...
    <div class="font12 pad10">
      <a
        class="color888"
        href="https://github.com/bluefox1688/vue-cli-multi-page"
        target="_blank"
      >https://github.com/bluefox1688/vue-cli-multi-page</a>
    </div>
    ...
    <div>
      ...
      <div class="note">
        <p>
          这里仅展示几个VUE UI的demo，更多组件demo请访问vux UI官网，官网地址：
          <a
            href="https://vux.li"
            target="_blank"
          >https://vux.li</a>
    ...
    <div class="martop15">
      ...
      <group>
        ...
        <cell title="dialogDemo" value is-link link="../heroDemo/jlink.html"></cell>
      </group>
    </div>
  </div>
</template>
